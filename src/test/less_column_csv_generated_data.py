...
file_location = "C:\\Users\\being\\PycharmProjects\\youtube_de_project1_directories\\sales_data_to_s3"
...
with open(csv_file_path, "w", newline="") as csvfile:
    ...
    csvwriter.writerow(["customer_id", "product_name", "sales_date", "sales_person_id", "price",
                        "quantity", "total_cost", "payment_mode"])
    ...
    for _ in range(200):
        ...
        csvwriter.writerow(
            [customer_id, product_name, sales_date.strftime("%Y-%m-%d"), sales_person_id,
